    ...
    <div id="overlay" class="sidebar-overlay" onclick="sidebarController.toggle()"></div>
        ...
        window.fetch = function(...args) {
            return originalFetch.apply(this, args).then(response => {
                if (response.status === 401) {
                    showSessionExpiredModal('student');
                }
                return response;
            });
        };
        ...
        function checkSession() {
            fetch('/check-session')
                ...
                .catch(() => showSessionExpiredModal('student'));
        }
                    ...
                    <div id="sessionExpiredModal" class="fixed inset-0 z-[9999] flex items-center justify-center">
                        ...
                        <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <button onclick="redirectToLogin('${role}')" class="w-full bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
