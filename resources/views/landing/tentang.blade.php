            ...
            <div class="animate-on-scroll">
                <div class="mb-8">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                        Perjalanan <span class="gradient-text">10 Tahun</span>
                    </h2>
                </div>

                <div class="space-y-6 text-gray-600 leading-relaxed">
                    <p class="text-lg">
                        SMP 54 Surabaya didirikan pada tahun <strong class="text-gray-900">2015</strong> dengan visi untuk menjadi lembaga pendidikan yang unggul dalam membentuk karakter dan prestasi siswa.
                    </p>
                    <p>
                        Selama lebih dari <strong class="text-gray-900">10 tahun</strong>, sekolah ini telah berkomitmen untuk memberikan pendidikan berkualitas tinggi dengan memadukan kurikulum nasional dan pengembangan karakter yang kuat.
                    </p>
                    <p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="news-card group animate-on-scroll hover:shadow-xl" style="animation-delay: 0.1s;">
                <div class="text-center mb-6">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-6">Misi Sekolah</h3>
                </div>
                <ul class="space-y-5 text-gray-700 px-4">
                    <li class="flex items-start gap-4">
                        <div class="w-7 h-7 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>
                            </svg>
                        </div>
                        <span class="flex-1 leading-relaxed">Menyelenggarakan pendidikan yang berkualitas</span>
                    </li>
                    <li class="flex items-start gap-4">
                        <div class="w-7 h-7 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                        ...
                        <span class="flex-1 leading-relaxed">Mengembangkan karakter siswa yang berakhlak mulia</span>
                    </li>
                    <li class="flex items-start gap-4">
                        <div class="w-7 h-7 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                        ...
                        <span class="flex-1 leading-relaxed">Meningkatkan prestasi akademik dan non-akademik</span>
                    </li>
                    <li class="flex items-start gap-4">
                        <div class="w-7 h-7 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                        ...
                        <span class="flex-1 leading-relaxed">Mempersiapkan siswa untuk masa depan yang cerah</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-custom">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="feature-card group text-center animate-on-scroll hover:shadow-lg" style="animation-delay: 0.1s;">
                ...
                <div class="text-3xl md:text-4xl font-bold gradient-text mb-2">10+</div>
            ...
            <div class="feature-card group text-center animate-on-scroll hover:shadow-lg" style="animation-delay: 0.2s;">
                ...
                <div class="text-3xl md:text-4xl font-bold gradient-text mb-2">800+</div>
            ...
            <div class="feature-card group text-center animate-on-scroll hover:shadow-lg" style="animation-delay: 0.3s;">
                ...
                <div class="text-3xl md:text-4xl font-bold gradient-text mb-2">42</div>
            ...
            <div class="feature-card group text-center animate-on-scroll hover:shadow-lg" style="animation-delay: 0.4s;">
                ...
                <div class="text-3xl md:text-4xl font-bold gradient-text mb-2">26</div>
